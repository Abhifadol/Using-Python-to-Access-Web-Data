...
9068 as our personal assistants who can take care of many things
...
speak 8107 to 6606 explain 405 to the computer what we would like it to 
 1585 do next.  If we knew this language, we could tell the 4857
computer to do tasks on our behalf that were repetitive.  
Interestingly, the kinds of things computers can do best
are often the kinds of things that we humans find boring
and mind-numbing.

For 8717 example, 4948 look 6693 at the first three paragraphs of this
...
2313 programmers, each competing for your attention and interest.  They try 590
...
7164 memory vanishes when the computer is turned off. 608
...
or 3290 flash 9819 memory 7509 (typically found in USB sticks and portable
 music players).
...
1674 a Python program, they have one and only one meaning to Python.  Later 23
as you write programs you will make up your own words that have meaning to 
8353 you called variables.   You will have great latitude in choosing
...
2404 sit, stay, and fetch.  When you talk to a dog and 7124
...
assert 6134  5143  2284  else      if        pass      yield    
...
329 human-to-dog language).  The nice thing about telling Python to speak 7546
...
is 8695 amazingly 1599 complex 3912 and powerful and very picky about 
...
PHP, 6517 Ruby, 5501 Basic, 14 Perl, JavaScript, and many more.  The actual hardware
...
4798 a machine language version of the program for the new machine.

6769 These programming language translators fall into two general categories:
(one) interpreters and (two) compilers.

An interpreter reads the source code of the program as written by the
4001 programmer, parses the source code, and interprets the instructions on the fly.
Python is an interpreter and when we are running Python interactively, 
9408 we can type a line of Python (a sentence) and Python processes it immediately 6603
...
4893 python, what exactly is happening? 592

The Python interpreter is written in a high-level language called C.  
You can look at the actual source code for the Python interpreter by
going to www.python.org and working your way to their source code.
1390 So Python is a program itself and it is compiled into machine code. 7534
...
Writing a program
6123  8242
7302 Typing commands into the Python interpreter is a great way to experiment 1583
...
3501 the Python program in the file.   When Python is reading your source code 2589
8398 from a file, it knows to stop when it reaches the end of the file. 933
